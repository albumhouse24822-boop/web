  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div className="absolute left-0 top-0 bottom-0 w-[88vw] max-w-md bg-[var(--ahps-cream)] overflow-y-auto">
        ...
        <a href="/quiz" className="flex items-center gap-3 px-5 py-4 bg-[var(--ahps-soft)]" onClick={onClose}>
        ...
        <ul className="divide-y divide-neutral-200">
          {NAVIGATION.filter(n => !n.href).map((n, idx) => (
            <li key={n.label}>
              <button onClick={() => setExpanded(expanded === idx ? null : idx)} className="w-full flex items-center justify-between px-5 py-4 text-left">
