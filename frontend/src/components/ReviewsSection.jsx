      ...
      <div className="flex items-center gap-1 text-[#e3a96b] mb-3">
        {Array.from({ length: 5 }).map((_, s) => (
          <Star
            ...
            size={14}
            fill={s < review.stars ? '#e3a96b' : 'transparent'}
            strokeWidth={1.5}
          />
        ))}
      </div>
      ...
      <div className="max-w-screen-2xl mx-auto px-4 lg:px-8">
        ...
        <div className="flex justify-center items-center gap-2 mt-8">
          <button
            ...
            className="w-10 h-10 border border-neutral-400 hover:bg-neutral-900 hover:text-white hover:border-neutral-900 disabled:opacity-40 disabled:hover:bg-transparent disabled:hover:text-neutral-900 transition-colors flex items-center justify-center"
          >
            <ChevronLeft size={18} />
          </button>
          <span className="text-xs text-neutral-600 mx-3 tabular-nums">
